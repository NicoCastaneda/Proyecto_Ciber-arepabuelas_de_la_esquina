                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <input
                                    ...
                                    className="w-full border border-amber-300 rounded-lg p-2 mt-1"
                                />
                                <p className="text-xs text-amber-600 mt-1">
                                    🔗 Abre <a href="https://www.pexels.com" target="_blank" className="underline">Pexels</a> para copiar una imagen.
                                </p>
